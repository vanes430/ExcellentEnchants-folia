...
public class RegistryHack_1_21_11 implements su.nightexpress.excellentenchants.nms.RegistryHack {
    ...
    public void unfreezeRegistry() {
        ...
        ItemSetRegistry.getByIdMap().forEach(RegistryHack_1_21_11::createItemsSet);
    }
